...
let s:medium_gray     = { "gui": "Gray",         "cterm": "243" }
let s:white           = { "gui": "White",        "cterm": "15"  }
let s:actual_white    = { "gui": "White",        "cterm": "231" }
let s:light_black     = { "gui": "DarkGray",     "cterm": "8"   }
let s:lighter_black   = { "gui": "Gray",         "cterm": "240" }
let s:subtle_black    = { "gui": "DarkGray",     "cterm": "236" }
let s:light_gray      = { "gui": "Gray",         "cterm": "249" }
let s:lighter_gray    = { "gui": "LightGray",    "cterm": "251" }
let s:subtle_gray     = { "gui": "LightGray",    "cterm": "250" }
let s:pink            = { "gui": "LightMagenta", "cterm": "9"   }
let s:dark_red        = { "gui": "DarkRed",      "cterm": "1"   }
let s:light_red       = { "gui": "LightRed",     "cterm": "1"   }
let s:orange          = { "gui": "Orange",       "cterm": "167" }
let s:darker_blue     = { "gui": "DarkBlue",     "cterm": "18"  }
let s:dark_blue       = { "gui": "SlateBlue",    "cterm": "4"   }
let s:blue            = { "gui": "Blue",         "cterm": "12"  }
let s:light_blue      = { "gui": "LightBlue",    "cterm": "153" }
let s:dark_cyan       = { "gui": "DarkCyan",     "cterm": "6"   }
let s:light_cyan      = { "gui": "LightCyan",    "cterm": "14"  }
let s:dark_green      = { "gui": "DarkGreen",    "cterm": "2"   }
let s:light_green     = { "gui": "LightGreen",   "cterm": "10"  }
let s:dark_purple     = { "gui": "DarkMagenta",  "cterm": "5"   }
let s:light_purple    = { "gui": "Magenta",      "cterm": "13"  }
let s:yellow          = { "gui": "Yellow",       "cterm": "11"  }
let s:dark_yellow     = { "gui": "DarkYellow",   "cterm": "3"   }

if &background == "dark"
  let s:bg              = s:black
  let s:bg_subtle       = s:light_black
  let s:bg_subtle_comment = s:light_gray
